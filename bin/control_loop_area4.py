...
wa_xbee_comm.transmit_sensor_message(ser,area4,'SEN1')

if area4.verbose:
        print("(4) Extract data from sensor node")
wa_xbee_comm.receive_sensor_message(ser,area4,'SEN1')
...
# wa_iot_comm.update_thingspeak(area4,'NBJZ3OJS90R9G2QM')
